...
import special from '@/components/detail'

const router = new Router({
    mode: 'history',
    routes: [
        {path: '/index', name: 'index', component: index, meta: {title: '久久贷'}},
        ...
        {path: '/special', name: 'special', component: special, meta: {title: '无视黑白户贷款'}},
    ]
})
